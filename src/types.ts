...
export type ImportImage={id:string;name:string;url:string;status:ImportStatus;drafts:Knowledge[];error?:string;kind?:'image'|'web';sourceUrl?:string};
...
export type Settings={apiBaseUrl:string;apiKey:string;chatModel:string;visionModel:string;visionContextTokens:number;visionMaxTokens:number;visionThinkingEnabled:boolean;visionReasoningEffort:'low'|'medium'|'high';databaseLocation:string};
