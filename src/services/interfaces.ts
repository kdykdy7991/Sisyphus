...
export interface SettingsService{get():Promise<Settings>;save(value:Settings):Promise<void>;profiles():Promise<LlmProfiles>;createProfile(name:string):Promise<string>;switchProfile(id:string):Promise<Settings>;deleteProfile(id:string):Promise<void>;testConnection():Promise<ConnectionResult>}
