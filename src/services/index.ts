...
import type { BackupService, ChatService, ImportService, KnowledgeService, LogsService, SettingsService, SyncService, WebDavService } from './interfaces';
...
export const logsService: LogsService = isTauri ? tauri.logsService : mock.logsService;