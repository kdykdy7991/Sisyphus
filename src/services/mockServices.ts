...
let settings: Settings = { apiBaseUrl: 'https://api.openai.com/v1', apiKey: '', chatModel: 'gpt-5', visionModel: 'gpt-5', visionMaxTokens: 32768, databaseLocation: '~/Library/Application Support/Interview Kit/interview.db' };
